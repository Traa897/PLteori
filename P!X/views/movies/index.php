...
<div class="hero-section">
    <div class="hero-content">
        ...
        <p>Jutaan film, acara TV, dan orang-orang untuk ditemukan. Jelajahi sekarang.</p>
        
        <form method="GET" action="index.php" class="hero-search">
            <input type="text" name="search" placeholder="Cari sebuah film, serial tv, kru / aktor..." 
